...
import { FIBONACCI_VALUES, FibonacciValue } from '@planning-poker/shared';
...
export function VotingCards({ onVote, disabled = false, selectedValue, hasVoted }: VotingCardsProps) {
